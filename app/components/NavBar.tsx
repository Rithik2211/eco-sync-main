      ...
      <div className='flex flex-row justify-between items-center z-1 w-full h-full'>
        ...
        <div className='flex justify-around items-center w-[500px] h-[40px] flex-wrap mr-[30px]'>
          ...
          <div className='flex items-center space-x-4'>
            <button className='rounded-full border px-6 py-2 text-sm font-medium text-black bg-[#04c052]'> Login </button>
            <button className="rounded-full border px-6 py-2 text-sm font-medium text-black bg-[#E5E8EB]"> Sign up </button>
          </div>
        </div>
      </div>
    </div>
